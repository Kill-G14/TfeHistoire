...
export const auth = {
  ...
  getToken() {
    return (
      localStorage.getItem("memoriaeventia_admin_token") ||
      sessionStorage.getItem("memoriaeventia_admin_token")
    );
  },
  ...
  getUser() {
    const userStr =
      localStorage.getItem("memoriaeventia_admin_user") ||
      sessionStorage.getItem("memoriaeventia_admin_user");
